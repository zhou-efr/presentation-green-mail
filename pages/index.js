...
export default function App() {
    ...
    return (
        <div className="">
            <div className="fixed top-3 left-3 h-10">
            ...
            <div className={"pt-14 w-screen h-screen flex justify-around"}>
                <div className={"w-1/2 h-full flex flex-col justify-center items-center"}>
                    <Image className={"h-1/3 object-contains"} src={"../public/bob.png"} width={300} height={200} layout={"intrinsic"}/>
                    <Image className={"h-1/3 object-contains"} src={"../public/alice.png"} width={300} height={200} layout={"intrinsic"} />
                </div>
                <div className={"w-1/2 h-full flex flex-col justify-center items-center"}>
